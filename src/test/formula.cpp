...
class Board {
 public:
  ...
  double score () {
    int depth = 0;
    int nb1 = 0, nb2 = 0, nb3 = 0, nb4 = 0, nb5 = 0, nb6 = 0, nb7 = 0, nb8 = 0, nb9 = 0, nb10 = 0;
    double eval = evalStack (depth);
    //return 1000.0 - abs (eval - 24.0);
    //fprintf (stderr, "depth %d\n", depth);
    for (int i = 0; i < length; i++) {
      if (rollout [i] == 0) nb1++;
      else if (rollout [i] == 1) nb2++;
      else if (rollout [i] == 2) nb3++;
      else if (rollout [i] == 3) nb4++;
      else if (rollout [i] == 4) nb5++;
      else if (rollout [i] == 5) nb6++;
      else if (rollout [i] == 6) nb7++;
      else if (rollout [i] == 7) nb8++;
      else if (rollout [i] == 8) nb9++;
      else if (rollout [i] == 9) nb10++;
    }
    if ((nb1 == 1) && (nb2 == 1) && (nb3 == 1) && (nb4 == 1) && (nb5 == 1) && (nb6 == 1) && (nb7 == 1) && (nb8 == 1) && (nb9 == 1) && (nb10 == 1)) {
      return 1000.0 - abs (eval - 737.0);
    }
    int score = (nb1 == 1) + (nb2 == 1) + (nb3 == 1) + (nb4 == 1) + (nb5 == 1) + (nb6 == 1) + (nb7 == 1) + (nb8 == 1) + (nb9 == 1) + (nb10 == 1);
    return score;
  }
};
