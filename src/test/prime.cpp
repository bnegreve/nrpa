...
bool isPrime (int n) {
  if (n < 2)
    return false;
  int stop = (int)sqrt (n);
  int i = 2, indicePrime = 0;
  while (i <= stop) {
    if ((n % i) == 0)
      return false;
    if (indicePrime < nbPrimes - 1) {
      indicePrime++;
      i = prime [indicePrime];
    }
    else
      //i += 2;
      return false; // to avoid long computations
  }
  return true; 
}
...
class Board {
 public:
  ...
  double score () {
	...
	//else
	  //return ((double)nb);
	  //return ((double)nb) + ((double)n) / 100.0;
      }
      else
	//return ((double)nb);
	return ((double)nb) + ((double)n) / 100.0;
    }
    return ((double)nb) + 0.99;
  }
};
...
void initFunctors () {
  init ();
  tableFunctor.add ("1", 0, true);
  tableFunctor.add ("2", 0, true);
  tableFunctor.add ("3", 0, true);
  tableFunctor.add ("4", 0, true);
  tableFunctor.add ("5", 0, true);
  tableFunctor.add ("6", 0, true);
  tableFunctor.add ("7", 0, true);
  tableFunctor.add ("8", 0, true);
  tableFunctor.add ("9", 0, true);
  tableFunctor.add ("10", 0, true);
  ...
  tableFunctor.add ("<", 2, false);
  tableFunctor.add ("=", 2, false);
  tableFunctor.add ("sqrt", 1, true);
  tableFunctor.add ("log", 1, true);
  ...
  tableFunctor.add ("fact", 1, true);
  tableFunctor.add ("11", 0, true);
  tableFunctor.add ("13", 0, true);
  tableFunctor.add ("17", 0, true);
  tableFunctor.add ("19", 0, true);
  tableFunctor.add ("23", 0, true);
  tableFunctor.add ("29", 0, true);
  tableFunctor.add ("31", 0, true);
  tableFunctor.add ("37", 0, true);
  tableFunctor.add ("41", 0, true);
  tableFunctor.add ("43", 0, true);
  tableFunctor.add ("47", 0, true);
  tableFunctor.add ("53", 0, true);
  tableFunctor.add ("59", 0, true);
  tableFunctor.add ("61", 0, true);
  tableFunctor.add ("67", 0, true);
  tableFunctor.add ("71", 0, true);
  tableFunctor.add ("73", 0, true);
  tableFunctor.add ("79", 0, true);
  tableFunctor.add ("83", 0, true);
  tableFunctor.add ("89", 0, true);
  tableFunctor.add ("97", 0, true);
 
  tableFunctor.add ("x", 0, true);
}
